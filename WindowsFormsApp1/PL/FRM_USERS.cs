...
{
    public partial class FRM_USERS : Form // بداية تعريف النموذج الرئيسي لإدارة الأصناف
    {
        ...
        public FRM_USERS() // بداية تعريف الدالة الرئيسية للنموذج
        {
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            PL.FRM_USERS_ADD frm_add = new PL.FRM_USERS_ADD();
            frm_add.id = 0;
        ...
        private void btn_delete_Click(object sender, EventArgs e) // بداية تعريف الدالة المرتبطة بزرار حذف مورد
        {
            ...
            if (id > 0)
            {
                ...
                try // بداية تعريف كتلة للتعامل مع الأخطاء الممكنة
                {
                    ...
                    var result = MessageBox.Show("عملية حذف", "هل تريد حذف عملية المستخدم ",
                    ...
                    {
                        tb_user = db.TB_USERS.Where(x => x.ID == id).FirstOrDefault(); // البحث عن المورد المحدد في قاعدة البيانات
                        db.Entry(tb_user).State = EntityState.Deleted; // تمييز المورد للحذف
        ...
        private void update_data() // بداية تعريف دالة تحديث البيانات في الجدول
        {
            ...
            gridControl1.DataSource = db.TB_USERS.ToList(); // تحميل البيانات الجديدة في الجدول
        ...
        private void btn_edit_Click(object sender, EventArgs e) // بداية تعريف الدالة المرتبطة بزرار تعديل مورد
        {
            ...
            frm_add.edt_name.Text = tb_user.Users_Name;
            frm_add.edt_pass.Text = tb_user.Users_Pass;
            frm_add.edt_roll.Text = tb_user.Users_Roll;
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            gridControl1.DataSource = db.TB_USERS.Where(x => x.Users_Name.Contains(_search)).ToList();
        }
        ...
        private void PerformSearch()
        {
            var _search = edt_search.Text;
            // نقوم بفلتر جلب البيانات بشكل مباشر  
            gridControl1.DataSource = db.TB_USERS
                .Where(x => x.Users_Name.Contains(_search) || x.Users_Roll.Contains(_search)|| x.Users_Roll.Contains(_search))
                .ToList();
        }
    }
}
